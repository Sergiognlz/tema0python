...
#variable texto con el emblemático comienzo de cierta novela cuyo nombre no quiero acordarme
...
"duelos y quebrantos los sábados, lentejas los viernes, algún palomino de añadidura los domingos, consumían las tres partes de su hacienda. " \
...
#creamos diccionario
diccionario={}
#for para recorrer el texto separado por espacios( función split() ) y recorremos por palabra
